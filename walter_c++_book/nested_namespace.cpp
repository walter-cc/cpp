...
cc@walter_c++_book$g++ nested_namespace.cpp -o test
...
namespace demo_namespace {
    ...
    namespace demo_sub_namespace {      // 命名空間 `demo_sub_namespace` 定義在 `demo_namespace`
...
int main(int argc, char *argv[]) {
    ...
    demo_namespace::demo_sub_namespace::Demo_class demo;    // `demo_namespace::` 表示 `Demo_class` 來自`demo_namespace`這個命名空間
